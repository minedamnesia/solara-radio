...
// Fetch function can be placed here or in a utils file
...
export default function HikingMapsWidget() {
  ...
  const handleParkSelect = async (park) => {
    ...
    try {
      const trails = await fetchTrailsFromOverpass(park.latitude, park.longitude);
      setTrails(trails);
    } catch (error) {
